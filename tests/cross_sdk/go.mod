module github.com/onflow/flow-py-sdk/tests/cross_sdk

go 1.25.0

require github.com/onflow/flow-go-sdk v0.0.0
...
replace github.com/onflow/flow-go-sdk => /Users/vishal/go/src/github.com/onflow/flow-go-sdk
